...
if __name__ == '__main__':
    ...
    df_actual_predicted_probs, fpr, tpr, thresholds, auroc, score = r.randfor_action(X_train_woe, X_test_woe, y_train.iloc[:,1], y_test.iloc[:,1], tr=0.5, class_weight={0:1, 1:40}, n_estimators=70, max_depth=None)
