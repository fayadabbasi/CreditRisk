...
class WOE:
    ...
    def action_woe(self, X_train):
        ...
        if 'int_rate_int' in X_train:
            ...
            df_inputs_prepr['int_rate_factor:1'] = np.where((df_inputs_prepr['int_rate'].isin(range(8))),1,0)
            df_inputs_prepr['int_rate_factor:2'] = np.where((df_inputs_prepr['int_rate'].isin(range(8,11))),1,0)
            df_inputs_prepr['int_rate_factor:3'] = np.where((df_inputs_prepr['int_rate'].isin(range(11,13))),1,0)
            df_inputs_prepr['int_rate_factor:4'] = np.where((df_inputs_prepr['int_rate'].isin(range(13,15))),1,0)
            df_inputs_prepr['int_rate_factor:5'] = np.where((df_inputs_prepr['int_rate'].isin(range(15,17))),1,0)
            df_inputs_prepr['int_rate_factor:6'] = np.where((df_inputs_prepr['int_rate'].isin(range(17,19))),1,0)
            df_inputs_prepr['int_rate_factor:7'] = np.where((df_inputs_prepr['int_rate'].isin(range(19,21))),1,0)
            df_inputs_prepr['int_rate_factor:8'] = np.where((df_inputs_prepr['int_rate'].isin(range(21,23))),1,0)
            df_inputs_prepr['int_rate_factor:9'] = np.where((df_inputs_prepr['int_rate'].isin(range(23,25))),1,0)
            df_inputs_prepr['int_rate_factor:10'] = np.where((df_inputs_prepr['int_rate'].isin(range(25,27))),1,0)
            df_inputs_prepr['int_rate_factor:11'] = np.where((df_inputs_prepr['int_rate'].isin(range(27,int(df_inputs_prepr['int_rate_int'].max())))),1,0)
        ...
        if 'revol_util_int' in X_train:
            ...
            df_inputs_prepr['revol_util_factor:1'] = np.where((df_inputs_prepr['revol_util'].isin(range(12))),1,0)
            df_inputs_prepr['revol_util_factor:2'] = np.where((df_inputs_prepr['revol_util'].isin(range(12,24))),1,0)
            df_inputs_prepr['revol_util_factor:3'] = np.where((df_inputs_prepr['revol_util'].isin(range(24,36))),1,0)
            df_inputs_prepr['revol_util_factor:4'] = np.where((df_inputs_prepr['revol_util'].isin(range(36,48))),1,0)
            df_inputs_prepr['revol_util_factor:5'] = np.where((df_inputs_prepr['revol_util'].isin(range(48,60))),1,0)
            df_inputs_prepr['revol_util_factor:6'] = np.where((df_inputs_prepr['revol_util'].isin(range(60,72))),1,0)
            df_inputs_prepr['revol_util_factor:7'] = np.where((df_inputs_prepr['revol_util'].isin(range(72,84))),1,0)
            df_inputs_prepr['revol_util_factor:8'] = np.where((df_inputs_prepr['revol_util'].isin(range(84,96))),1,0)
            df_inputs_prepr['revol_util_factor:9'] = np.where((df_inputs_prepr['revol_util'].isin(range(96,int(df_inputs_prepr['revol_util_int'].max())))),1,0)
        ...
        if 'zip_code_int' in X_train:
            ...
            df_inputs_prepr['zip_code:1'] = np.where((df_inputs_prepr['zip_code'].isin(range(200))),1,0)
            df_inputs_prepr['zip_code:2'] = np.where((df_inputs_prepr['zip_code'].isin(range(200,400))),1,0)
            df_inputs_prepr['zip_code:3'] = np.where((df_inputs_prepr['zip_code'].isin(range(400,600))),1,0)
            df_inputs_prepr['zip_code:4'] = np.where((df_inputs_prepr['zip_code'].isin(range(600,800))),1,0)
            df_inputs_prepr['zip_code:5'] = np.where((df_inputs_prepr['zip_code'].isin(range(800,int(df_inputs_prepr['zip_code_int'].max())))),1,0)
