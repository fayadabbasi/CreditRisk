...
class WOE:
    ...
    def action_woe(self, X_train):
        ...
        if 'dti' in X_train:
            ...
            df_inputs_prepr['dti_factor:1'] = np.where((df_inputs_prepr['dti_factor'].isin(range(8))),1,0)
            df_inputs_prepr['dti_factor:2'] = np.where((df_inputs_prepr['dti_factor'].isin(range(8,12))),1,0)
            df_inputs_prepr['dti_factor:3'] = np.where((df_inputs_prepr['dti_factor'].isin(range(12,14))),1,0)
            df_inputs_prepr['dti_factor:4'] = np.where((df_inputs_prepr['dti_factor'].isin(range(14,16))),1,0)
            df_inputs_prepr['dti_factor:5'] = np.where((df_inputs_prepr['dti_factor'].isin(range(16,20))),1,0)
            df_inputs_prepr['dti_factor:6'] = np.where((df_inputs_prepr['dti_factor'].isin(range(20,25))),1,0)
            df_inputs_prepr['dti_factor:7'] = np.where((df_inputs_prepr['dti_factor'].isin(range(25,int(df_inputs_prepr['dti'].max())))),1,0)
        ...
        if 'installment' in X_train:
            ...
            df_inputs_prepr['installment_factor:1'] = np.where((df_inputs_prepr['installment_factor'].isin(range(180))),1,0)
            df_inputs_prepr['installment_factor:2'] = np.where((df_inputs_prepr['installment_factor'].isin(range(180,355))),1,0)
            df_inputs_prepr['installment_factor:3'] = np.where((df_inputs_prepr['installment_factor'].isin(range(355,530))),1,0)
            df_inputs_prepr['installment_factor:4'] = np.where((df_inputs_prepr['installment_factor'].isin(range(530,706))),1,0)
            df_inputs_prepr['installment_factor:5'] = np.where((df_inputs_prepr['installment_factor'].isin(range(706,880))),1,0)
            df_inputs_prepr['installment_factor:6'] = np.where((df_inputs_prepr['installment_factor'].isin(range(880,1055))),1,0)
            df_inputs_prepr['installment_factor:7'] = np.where((df_inputs_prepr['installment_factor'].isin(range(1055,int(df_inputs_prepr['installment'].max())))),1,0)
        ...
        if 'fico_range_low' in X_train:
            ...
            df_inputs_prepr['fico_range_low_factor:1'] = np.where((df_inputs_prepr['fico_range_low_factor'].isin(range(680))),1,0)
            df_inputs_prepr['fico_range_low_factor:2'] = np.where((df_inputs_prepr['fico_range_low_factor'].isin(range(680,700))),1,0)
            df_inputs_prepr['fico_range_low_factor:3'] = np.where((df_inputs_prepr['fico_range_low_factor'].isin(range(700,730))),1,0)
            df_inputs_prepr['fico_range_low_factor:4'] = np.where((df_inputs_prepr['fico_range_low_factor'].isin(range(730,760))),1,0)
            df_inputs_prepr['fico_range_low_factor:5'] = np.where((df_inputs_prepr['fico_range_low_factor'].isin(range(760,int(df_inputs_prepr['fico_range_low'].max())))),1,0)
        ...
        if 'total_acc' in X_train:
            ...
            df_inputs_prepr['total_acc_factor:1'] = np.where((df_inputs_prepr['total_acc_factor'].isin(range(18))),1,0)
            df_inputs_prepr['total_acc_factor:2'] = np.where((df_inputs_prepr['total_acc_factor'].isin(range(18,25))),1,0)
            df_inputs_prepr['total_acc_factor:3'] = np.where((df_inputs_prepr['total_acc_factor'].isin(range(25,30))),1,0)
            df_inputs_prepr['total_acc_factor:4'] = np.where((df_inputs_prepr['total_acc_factor'].isin(range(30,38))),1,0)
            df_inputs_prepr['total_acc_factor:5'] = np.where((df_inputs_prepr['total_acc_factor'].isin(range(38,int(df_inputs_prepr['total_acc'].max())))),1,0)
        ...
        if 'pub_rec' in X_train:
            ...
            df_inputs_prepr['pub_rec_factor:1'] = np.where((df_inputs_prepr['pub_rec_factor'].isin(range(1))),1,0)
            df_inputs_prepr['pub_rec_factor:2'] = np.where((df_inputs_prepr['pub_rec_factor'].isin(range(1,5))),1,0)
            df_inputs_prepr['pub_rec_factor:3'] = np.where((df_inputs_prepr['pub_rec_factor'].isin(range(5,int(df_inputs_prepr['pub_rec'].max())))),1,0)
        ...
        if 'inq_last_6mths' in X_train:
            ...
            df_inputs_prepr['inq_last_6mths_factor:1'] = np.where((df_inputs_prepr['inq_last_6mths_factor'].isin(range(1))),1,0)
            df_inputs_prepr['inq_last_6mths_factor:2'] = np.where((df_inputs_prepr['inq_last_6mths_factor'].isin(range(1,4))),1,0)
            df_inputs_prepr['inq_last_6mths_factor:3'] = np.where((df_inputs_prepr['inq_last_6mths_factor'].isin(range(4,int(df_inputs_prepr['inq_last_6mths'].max())))),1,0)
        ...
        if 'delinq_2yrs' in X_train:
            ...
            df_inputs_prepr['delinq_2yrs_factor:1'] = np.where((df_inputs_prepr['delinq_2yrs_factor'].isin(range(1))),1,0)
            df_inputs_prepr['delinq_2yrs_factor:2'] = np.where((df_inputs_prepr['delinq_2yrs_factor'].isin(range(1,4))),1,0)
            df_inputs_prepr['delinq_2yrs_factor:3'] = np.where((df_inputs_prepr['delinq_2yrs_factor'].isin(range(4,int(df_inputs_prepr['delinq_2yrs'].max())))),1,0)
        ...
        if 'funded_amnt' in X_train:
            ...
            df_inputs_prepr['funded_amnt_factor:1'] = np.where((df_inputs_prepr['funded_amnt_factor'].isin(range(8000))),1,0)
            df_inputs_prepr['funded_amnt_factor:2'] = np.where((df_inputs_prepr['funded_amnt_factor'].isin(range(8000,12000))),1,0)
            df_inputs_prepr['funded_amnt_factor:3'] = np.where((df_inputs_prepr['funded_amnt_factor'].isin(range(12000,20000))),1,0)
            df_inputs_prepr['funded_amnt_factor:4'] = np.where((df_inputs_prepr['funded_amnt_factor'].isin(range(20000,int(df_inputs_prepr['funded_amnt'].max())))),1,0)
        ...
        if 'funded_amnt_inv' in X_train:
            ...
            df_inputs_prepr['funded_amnt_inv_factor:1'] = np.where((df_inputs_prepr['funded_amnt_inv_factor'].isin(range(8000))),1,0)
            df_inputs_prepr['funded_amnt_inv_factor:2'] = np.where((df_inputs_prepr['funded_amnt_inv_factor'].isin(range(8000,12000))),1,0)
            df_inputs_prepr['funded_amnt_inv_factor:3'] = np.where((df_inputs_prepr['funded_amnt_inv_factor'].isin(range(12000,20000))),1,0)
            df_inputs_prepr['funded_amnt_inv_factor:4'] = np.where((df_inputs_prepr['funded_amnt_inv_factor'].isin(range(20000,int(df_inputs_prepr['funded_amnt_inv'].max())))),1,0)
        ...
        if 'revol_bal' in X_train:
            ...
            df_inputs_prepr['revol_bal_factor:1'] = np.where((df_inputs_prepr['revol_bal_factor'].isin(range(10))),1,0)
            df_inputs_prepr['revol_bal_factor:2'] = np.where((df_inputs_prepr['revol_bal_factor'].isin(range(10,5000))),1,0)
            df_inputs_prepr['revol_bal_factor:3'] = np.where((df_inputs_prepr['revol_bal_factor'].isin(range(5000,20000))),1,0)
            df_inputs_prepr['revol_bal_factor:4'] = np.where((df_inputs_prepr['revol_bal_factor'].isin(range(20000,int(df_inputs_prepr['revol_bal'].max())))),1,0)
        ...
        if 'tax_liens' in X_train:
            ...
            df_inputs_prepr['tax_liens_factor:1'] = np.where((df_inputs_prepr['tax_liens_factor'].isin(range(1))),1,0)
            df_inputs_prepr['tax_liens_factor:2'] = np.where((df_inputs_prepr['tax_liens_factor'].isin(range(1,2))),1,0)
            df_inputs_prepr['tax_liens_factor:3'] = np.where((df_inputs_prepr['tax_liens_factor'].isin(range(2,5))),1,0)
            df_inputs_prepr['tax_liens_factor:4'] = np.where((df_inputs_prepr['tax_liens_factor'].isin(range(5,int(df_inputs_prepr['tax_liens'].max())))),1,0)
        ...
        if 'all_util' in X_train:
            ...
            df_inputs_prepr['all_util_factor:1'] = np.where((df_inputs_prepr['all_util_factor'].isin(range(1))),1,0)
            df_inputs_prepr['all_util_factor:2'] = np.where((df_inputs_prepr['all_util_factor'].isin(range(1,25))),1,0)
            df_inputs_prepr['all_util_factor:3'] = np.where((df_inputs_prepr['all_util_factor'].isin(range(25,50))),1,0)
            df_inputs_prepr['all_util_factor:4'] = np.where((df_inputs_prepr['all_util_factor'].isin(range(50,int(df_inputs_prepr['all_util'].max())))),1,0)
        ...
        if 'delinq_amnt' in X_train:
            ...
            df_inputs_prepr['delinq_amnt_factor:1'] = np.where((df_inputs_prepr['delinq_amnt_factor'].isin(range(1))),1,0)
            df_inputs_prepr['delinq_amnt_factor:2'] = np.where((df_inputs_prepr['delinq_amnt_factor'].isin(range(1,25))),1,0)
            df_inputs_prepr['delinq_amnt_factor:3'] = np.where((df_inputs_prepr['delinq_amnt_factor'].isin(range(25,50))),1,0)
            df_inputs_prepr['delinq_amnt_factor:4'] = np.where((df_inputs_prepr['delinq_amnt_factor'].isin(range(50,int(df_inputs_prepr['delinq_amnt'].max())))),1,0)
        ...
        if 'inq_fi' in X_train:
            ...
            df_inputs_prepr['inq_fi_factor:1'] = np.where((df_inputs_prepr['inq_fi_factor'].isin(range(1))),1,0)
            df_inputs_prepr['inq_fi_factor:2'] = np.where((df_inputs_prepr['inq_fi_factor'].isin(range(1,2))),1,0)
            df_inputs_prepr['inq_fi_factor:3'] = np.where((df_inputs_prepr['inq_fi_factor'].isin(range(2,4))),1,0)
            df_inputs_prepr['inq_fi_factor:4'] = np.where((df_inputs_prepr['inq_fi_factor'].isin(range(4,int(df_inputs_prepr['inq_fi'].max())))),1,0)
        ...
        if 'mths_since_last_delinq' in X_train:
            ...
            df_inputs_prepr['mths_since_last_delinq_factor:1'] = np.where((df_inputs_prepr['mths_since_last_delinq_factor'].isin(range(1))),1,0)
            df_inputs_prepr['mths_since_last_delinq_factor:2'] = np.where((df_inputs_prepr['mths_since_last_delinq_factor'].isin(range(1,10))),1,0)
            df_inputs_prepr['mths_since_last_delinq_factor:3'] = np.where((df_inputs_prepr['mths_since_last_delinq_factor'].isin(range(10,50))),1,0)
            df_inputs_prepr['mths_since_last_delinq_factor:4'] = np.where((df_inputs_prepr['mths_since_last_delinq_factor'].isin(range(50,int(df_inputs_prepr['mths_since_last_delinq'].max())))),1,0)
        ...
        if 'num_accts_ever_120_pd' in X_train:
            ...
            df_inputs_prepr['num_accts_ever_120_pd_factor:1'] = np.where((df_inputs_prepr['num_accts_ever_120_pd_factor'].isin(range(1))),1,0)
            df_inputs_prepr['num_accts_ever_120_pd_factor:2'] = np.where((df_inputs_prepr['num_accts_ever_120_pd_factor'].isin(range(1,2))),1,0)
            df_inputs_prepr['num_accts_ever_120_pd_factor:3'] = np.where((df_inputs_prepr['num_accts_ever_120_pd_factor'].isin(range(2,4))),1,0)
            df_inputs_prepr['num_accts_ever_120_pd_factor:4'] = np.where((df_inputs_prepr['num_accts_ever_120_pd_factor'].isin(range(4,int(df_inputs_prepr['num_accts_ever_120_pd'].max())))),1,0)
        ...
        if 'num_actv_rev_tl' in X_train:
            ...
            df_inputs_prepr['num_actv_rev_tl_factor:1'] = np.where((df_inputs_prepr['num_actv_rev_tl_factor'].isin(range(2))),1,0)
            df_inputs_prepr['num_actv_rev_tl_factor:2'] = np.where((df_inputs_prepr['num_actv_rev_tl_factor'].isin(range(2,5))),1,0)
            df_inputs_prepr['num_actv_rev_tl_factor:3'] = np.where((df_inputs_prepr['num_actv_rev_tl_factor'].isin(range(5,8))),1,0)
            df_inputs_prepr['num_actv_rev_tl_factor:4'] = np.where((df_inputs_prepr['num_actv_rev_tl_factor'].isin(range(8,int(df_inputs_prepr['num_actv_rev_tl'].max())))),1,0)
        ...
        if 'num_rev_accts' in X_train:
            ...
            df_inputs_prepr['num_rev_accts_factor:1'] = np.where((df_inputs_prepr['num_rev_accts_factor'].isin(range(5))),1,0)
            df_inputs_prepr['num_rev_accts_factor:2'] = np.where((df_inputs_prepr['num_rev_accts_factor'].isin(range(5,10))),1,0)
            df_inputs_prepr['num_rev_accts_factor:3'] = np.where((df_inputs_prepr['num_rev_accts_factor'].isin(range(10,20))),1,0)
            df_inputs_prepr['num_rev_accts_factor:4'] = np.where((df_inputs_prepr['num_rev_accts_factor'].isin(range(20,int(df_inputs_prepr['num_rev_accts'].max())))),1,0)
        ...
        if 'total_rec_late_fee' in X_train:
            ...
            df_inputs_prepr['total_rec_late_fee_factor:1'] = np.where((df_inputs_prepr['total_rec_late_fee_factor'].isin(range(1))),1,0)
            df_inputs_prepr['total_rec_late_fee_factor:2'] = np.where((df_inputs_prepr['total_rec_late_fee_factor'].isin(range(1,15))),1,0)
            df_inputs_prepr['total_rec_late_fee_factor:3'] = np.where((df_inputs_prepr['total_rec_late_fee_factor'].isin(range(15,30))),1,0)
            df_inputs_prepr['total_rec_late_fee_factor:4'] = np.where((df_inputs_prepr['total_rec_late_fee_factor'].isin(range(30,int(df_inputs_prepr['total_rec_late_fee'].max())))),1,0)
